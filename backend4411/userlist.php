...
class cuser_list extends cuser {
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->user_id->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'>";
...
<?php if ($user->tipe->Visible) { // tipe ?>
	<?php if ($user->SortUrl($user->tipe) == "") { ?>
		<th data-name="tipe"><div id="elh_user_tipe" class="user_tipe"><div class="ewTableHeaderCaption"><?php echo $user->tipe->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="tipe"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->tipe) ?>',1);"><div id="elh_user_tipe" class="user_tipe">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->tipe->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->tipe->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->tipe->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<?php echo $user->password->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($user->tipe->Visible) { // tipe ?>
		<td data-name="tipe"<?php echo $user->tipe->CellAttributes() ?>>
<span<?php echo $user->tipe->ViewAttributes() ?>>
<?php echo $user->tipe->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
