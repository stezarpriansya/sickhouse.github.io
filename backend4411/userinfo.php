...
class cuser extends cTable {
	...
	function __construct() {
		...
		// user_id
		$this->user_id = new cField('user', 'user', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// tipe
		$this->tipe = new cField('user', 'user', 'x_tipe', 'tipe', '`tipe`', '`tipe`', 3, -1, FALSE, '`tipe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
