...
<?php if ($user->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_user_user_id" class="col-sm-2 control-label ewLabel"><?php echo $user->user_id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $user->user_id->CellAttributes() ?>>
...
<input type="hidden" data-field="x_user_id" name="x_user_id" id="x_user_id" value="<?php echo ew_HtmlEncode($user->user_id->CurrentValue) ?>">
