...
define("EW_PROJECT_NAME", "project3", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{E4257960-51C0-4B8A-8F41-FDCC3F20971D}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'VFxyN55onyOPleAj', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/project3.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_PASS", 'finahn1l4m', TRUE);
define("EW_CONN_DB", 'rumahsakitfp', TRUE);
...
define("EW_USER_PROFILE_SESSION_TIMEOUT", 0, TRUE);
...
define("EW_USER_PROFILE_PASSWORD_EXPIRE", 0, TRUE);
