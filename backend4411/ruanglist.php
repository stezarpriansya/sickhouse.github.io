...
class cruang_list extends cruang {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->kode_ruang->setFormValue($arrKeyFlds[0]);
		}
		return TRUE;
	}
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->jenis_ruang, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->gedung, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->jenis_ruang); // jenis_ruang
			$this->UpdateSort($this->gedung); // gedung
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->kode_ruang->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'>";
	...
	function RenderOtherOptions() {
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->CustomActions as $action => $name) {
				...
				$item->Body = "<a class=\"ewAction ewCustomAction\" href=\"\" onclick=\"ew_SubmitSelected(document.fruanglist, '" . ew_CurrentUrl() . "', null, '" . $action . "');return false;\">" . $name . "</a>";
			}
...
// Page object
var ruang_list = new ew_Page("ruang_list");
ruang_list.PageID = "list"; // Page ID
var EW_PAGE_ID = ruang_list.PageID; // For backward compatibility

// Form object
var fruanglist = new ew_Form("fruanglist");
...
var fruanglistsrch = new ew_Form("fruanglistsrch");
</script>
<script type="text/javascript">
...
<?php
	...
	if ($ruang->CurrentAction == "" && $ruang_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$ruang_list->setWarningMessage($Language->Phrase("NoPermission"));
...
<?php $SearchPanelClass = ($ruang_list->SearchWhere <> "") ? " in" : " in"; ?>
...
<?php if ($ruang->kode_ruang->Visible) { // kode_ruang ?>
	<?php if ($ruang->SortUrl($ruang->kode_ruang) == "") { ?>
		<th data-name="kode_ruang"><div id="elh_ruang_kode_ruang" class="ruang_kode_ruang"><div class="ewTableHeaderCaption"><?php echo $ruang->kode_ruang->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="kode_ruang"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $ruang->SortUrl($ruang->kode_ruang) ?>',1);"><div id="elh_ruang_kode_ruang" class="ruang_kode_ruang">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $ruang->kode_ruang->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($ruang->kode_ruang->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($ruang->kode_ruang->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($ruang->nama_ruang->Visible) { // nama_ruang ?>
	<?php if ($ruang->SortUrl($ruang->nama_ruang) == "") { ?>
		<th data-name="nama_ruang"><div id="elh_ruang_nama_ruang" class="ruang_nama_ruang"><div class="ewTableHeaderCaption"><?php echo $ruang->nama_ruang->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nama_ruang"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $ruang->SortUrl($ruang->nama_ruang) ?>',1);"><div id="elh_ruang_nama_ruang" class="ruang_nama_ruang">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $ruang->nama_ruang->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($ruang->nama_ruang->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($ruang->nama_ruang->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($ruang->jenis_ruang->Visible) { // jenis_ruang ?>
	<?php if ($ruang->SortUrl($ruang->jenis_ruang) == "") { ?>
		<th data-name="jenis_ruang"><div id="elh_ruang_jenis_ruang" class="ruang_jenis_ruang"><div class="ewTableHeaderCaption"><?php echo $ruang->jenis_ruang->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jenis_ruang"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $ruang->SortUrl($ruang->jenis_ruang) ?>',1);"><div id="elh_ruang_jenis_ruang" class="ruang_jenis_ruang">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $ruang->jenis_ruang->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($ruang->jenis_ruang->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($ruang->jenis_ruang->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($ruang->gedung->Visible) { // gedung ?>
	<?php if ($ruang->SortUrl($ruang->gedung) == "") { ?>
		<th data-name="gedung"><div id="elh_ruang_gedung" class="ruang_gedung"><div class="ewTableHeaderCaption"><?php echo $ruang->gedung->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="gedung"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $ruang->SortUrl($ruang->gedung) ?>',1);"><div id="elh_ruang_gedung" class="ruang_gedung">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $ruang->gedung->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($ruang->gedung->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($ruang->gedung->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($ruang->kode_ruang->Visible) { // kode_ruang ?>
		<td data-name="kode_ruang"<?php echo $ruang->kode_ruang->CellAttributes() ?>>
<span<?php echo $ruang->kode_ruang->ViewAttributes() ?>>
<?php echo $ruang->kode_ruang->ListViewValue() ?></span>
...
<?php echo $ruang->nama_ruang->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($ruang->jenis_ruang->Visible) { // jenis_ruang ?>
		<td data-name="jenis_ruang"<?php echo $ruang->jenis_ruang->CellAttributes() ?>>
<span<?php echo $ruang->jenis_ruang->ViewAttributes() ?>>
<?php echo $ruang->jenis_ruang->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($ruang->gedung->Visible) { // gedung ?>
		<td data-name="gedung"<?php echo $ruang->gedung->CellAttributes() ?>>
<span<?php echo $ruang->gedung->ViewAttributes() ?>>
<?php echo $ruang->gedung->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
...
<?php if ($ruang_list->Pager->RecordCount > 0) { ?>
<div class="ewPager">
