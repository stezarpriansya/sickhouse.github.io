...
<span id="el_user_user_id" class="form-group">
...
<?php if ($user->tipe->Visible) { // tipe ?>
	<tr id="r_tipe">
		<td><span id="elh_user_tipe"><?php echo $user->tipe->FldCaption() ?></span></td>
		<td<?php echo $user->tipe->CellAttributes() ?>>
<span id="el_user_tipe" class="form-group">
<span<?php echo $user->tipe->ViewAttributes() ?>>
<?php echo $user->tipe->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
