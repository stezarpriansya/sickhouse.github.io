...
<?php if ($user->user_id->Visible) { // user_id ?>
		<th><span id="elh_user_user_id" class="user_user_id"><?php echo $user->user_id->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($user->tipe->Visible) { // tipe ?>
		<th><span id="elh_user_tipe" class="user_tipe"><?php echo $user->tipe->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $user_delete->RowCnt ?>_user_user_id" class="form-group user_user_id">
...
<?php } ?>
<?php if ($user->tipe->Visible) { // tipe ?>
		<td<?php echo $user->tipe->CellAttributes() ?>>
<span id="el<?php echo $user_delete->RowCnt ?>_user_tipe" class="form-group user_tipe">
